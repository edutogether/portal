...
- **상태**: **프리즈됨** — 최신 태그 `portal-freeze-20260902`(긴급 보안수정 + public/ 긍정목록 구조전환 + 자산 최적화 반영 시점). 그 이전 태그들은 옮기지 말고 보존: `20260813/14/14b/17/20/23/23b/24/24b/25/25b/824c/25c/25d/25e/25f/25g/25h/26/26b/26c/26d/26e/26f/26f2/26g/829/901/901-final/901-firebase/901-audited`. `edutogether.kr`는 2026-08-25에 GitHub 조직 도메인 인증(Verified) 완료됨(이건 GitHub 조직 인증이라 Firebase 이전과 무관하게 유지됨).
