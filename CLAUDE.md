...
- **상태**: **프리즈됨, 실운영 모드** — 최신 태그 `portal-freeze-20260903-audited-100`(실사용 중 발견된 로딩화면 버그 수정(아래) 반영 후 Sonnet+Opus 독립 재감사 100/100 재확인 시점, 태그 메시지에 감사 상세 전문 있음). 다음 정기감사는 **2026-09-30** 예정 — 그 전까지는 이 세션이 먼저 나서서 재감사·재작업을 제안하지 않는다(대표 지시). 그 이전 태그들은 옮기지 말고 보존: `20260813/14/14b/17/20/23/23b/24/24b/25/25b/824c/25c/25d/25e/25f/25g/25h/26/26b/26c/26d/26e/26f/26f2/26g/829/901/901-final/901-firebase/901-audited/902/902-audited-100`. `edutogether.kr`는 2026-08-25에 GitHub 조직 도메인 인증(Verified) 완료됨(이건 GitHub 조직 인증이라 Firebase 이전과 무관하게 유지됨).
